...
const Expenses = () => {
  ...
  const options = {
    ...
    headers: {
      authorization:
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiOGI1OTVhYTctNGM3Yy00ODczLWI1NmMtNTNiZjUyMDY0Mjc5IiwidHlwZSI6ImFwaV90b2tlbiJ9.X2ZnbIZVoixql9mmcQKnlK2jXzhf-TLWeAz80Z_06z8",
    },
    data: {
      providers: "openai",
